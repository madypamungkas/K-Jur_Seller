...
import com.komsi.lab.kjurseller.ProductLiveReportUSActivity;
...
public class LocationTodayLLUpdateStockAdapter extends RecyclerView.Adapter<LocationTodayLLUpdateStockAdapter.CustomViewHolder>{

    List<LocationToday> locationTodays;
    List<String> colors;

    public LocationTodayLLUpdateStockAdapter(List<LocationToday> locationTodays) {
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Intent intent = new Intent(itemView.getContext() , ProductLiveReportUSActivity.class);
