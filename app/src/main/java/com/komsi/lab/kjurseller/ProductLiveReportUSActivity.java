...
import com.komsi.lab.kjurseller.adapter.ProductListLLUpdateStockAdapter;
...
public class ProductLiveReportUSActivity extends AppCompatActivity {
    private ArrayList<ProductToday> productLiveReportList;
    private RecyclerView recyclerView;
    private ProductListLLUpdateStockAdapter plAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_product_live_report_us);
    ...
    {
        super.onResume();
        loading = ProgressDialog.show(ProductLiveReportUSActivity.this, null, getString(R.string.please_wait), true, false);
        productList();
    }
    ...
    private void productList() {
        ...
        call.enqueue(new Callback<ProductListTodayResponse>() {
            ...
            public void onResponse(Call<ProductListTodayResponse> call, Response<ProductListTodayResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (productListTodayResponse.getStatus().equals("success")) {
                        ...
                        plAdapter = new ProductListLLUpdateStockAdapter(productLiveReportList);
            ...
            public void onFailure(Call<ProductListTodayResponse> call, Throwable t) {
                loading.dismiss();
                swipeContainer.setRefreshing(false);
                Toast.makeText(ProductLiveReportUSActivity.this, "Something wrong. Try again later", Toast.LENGTH_LONG).show();
