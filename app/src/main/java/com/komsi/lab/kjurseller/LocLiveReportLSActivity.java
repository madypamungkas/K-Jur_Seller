...
import com.komsi.lab.kjurseller.adapter.LocationTodayLLLiveSalesAdapter;
...
public class LocLiveReportLSActivity extends AppCompatActivity {
    private ArrayList<LocationToday> locationTodayList;
    private RecyclerView recyclerView;
    private LocationTodayLLLiveSalesAdapter lAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loc_live_report_ls);
    ...
    {
        super.onResume();
        loading = ProgressDialog.show(LocLiveReportLSActivity.this, null, getString(R.string.please_wait), true, false);
        locToday();
    }
    ...
    private void locToday() {
        ...
        call.enqueue(new Callback<LocationTodayResponse>() {
            ...
            public void onResponse(Call<LocationTodayResponse> call, Response<LocationTodayResponse> response) {
                ...
                if (response.isSuccessful()) {
                    if (locationTodayResponse.getStatus().equals("success")) {
                        ...
                        lAdapter = new LocationTodayLLLiveSalesAdapter(locationTodayList);
            ...
            public void onFailure(Call<LocationTodayResponse> call, Throwable t) {
                loading.dismiss();
                swipeContainer.setRefreshing(false);
                Toast.makeText(LocLiveReportLSActivity.this, "Something wrong. Try again later", Toast.LENGTH_LONG).show();
